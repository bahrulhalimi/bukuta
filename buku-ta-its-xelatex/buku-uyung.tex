    ...
    \chapter{DESAIN DAN PERANCANGAN}
		...
		\section{Arsitektur Sistem}
			...
			\subsection{Desain Rinci Balancer}
			    \textit{Balancer} berperan penting dalam sistem. Setiap permintaan yang masuk ke dalam sistem akan diolah oleh balancer dan dikembalikan ke pengguna setelah mendapat balasan dari \textit{worker}. Dalam beb
		\section{Deskripsi Umum Kebutuhan}
			...
			\subsection{Deskripsi Kebutuhan Fungsional}
				...
				\begin{ltabulary}{|L|L|} % L = Rata kiri untuk setiap kolom, | = garis batas vertikal.
					...
					\caption{Kebutuhan Fungsional} \label{tabelKebutuhanFungsional} \\
					\hline
					\textbf{Kode Kebutuhan Fungsional} & \textbf{Kebutuhan Fungsional} \\ \hline
					...
					% Isi Tabel
					F-0001 & Melayani permintaan halaman web \\ \hline
					F-0002 & Membagi beban kerja berdasarkan URL yang diakses pengguna \\ \hline
					F-0003 & Mengeluarkan \textit{worker} dari \textit{cluster} ketika tidak dapat melayani \\ \hline
					F-0004 & Mengelola \textit{worker} di dalam \textit{cluster} \\ \hline
					F-0005 & Mengelola URL yang diakses pengguna \\ \hline
					F-0006 & Mengaktifkan dan mematikan sistem \\ \hline
					
				\end{ltabulary}
				
			\subsection{Deskripsi Kebutuhan Non-Fungsional}
			...
			\subsection{Karakteristik Pengguna}
				Sistem yang dibangun dalam Tugas Akhir ini hanya memiliki satu aktor utama yaitu administrator sistem, selanjutnya disebut admin. Dalam kenyataannya admin adalah seorang manusia. Aktor lain di luar manusia adalah \textit{load balancer}, selanjutnya disebut \textit{balancer}. Penjelasan tentang aktor dalam sistem dijabarkan pada Tabel \ref{tabelKarasteristikPengguna}.
				
				\begin{ltabulary}{|L|L|L|} % L = Rata kiri untuk setiap kolom, | = garis batas vertikal.
					
					% Kepala tabel, berulang di setiap halaman
					\captionsetup{justification=centering}
					\caption{Karakteristik Pengguna} \label{tabelKarasteristikPengguna} \\
					\hline
					\textbf{Nama Aktor} & \textbf{Tugas} & \textbf{Hak Akses Aplikasi} \\ \hline
					...
					% Isi Tabel
					Admin & Mengelola sistem \textit{load balancer} & Mematikan dan mengaktifkan sistem, mengelola \textit{cluster}, mengelola URL \\ \hline
					\textit{Balancer} & Menyediakan layanan web & Menyediakan layanan web dan membagi beban kerja \\ \hline

					
				\end{ltabulary}
				
	        \subsection{Digram Kasus Penggunaan}
		        
		        Kebutuhan fungsional yang telah dirancang dalam pembahasan sebelumnya dimodelkan dalam bentuk diagram kasus penggunaa. Terdapat dua aktor dengan masing-masing tiga aktivitas dalam sistem yang digambarkan pada Gambar \ref{gambarDiagramKasusPenggunaan}.
