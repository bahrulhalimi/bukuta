...
if (akhir > awal) {
	...
	pengguna = cookie.substring(awal, cookie.length)
				...
				NodeJS sudah menyediakan paket yang memberikan layanan \textit{load balancing} namun mekanisme untuk membagi beban diserahkan kepada pengembang. Paket yang digunakan adalah \texttt{http-proxy}. 
				
				Kode program untuk implementasi \textit{balancer} tertera pada Kode Program \ref{implemenBalancer}
